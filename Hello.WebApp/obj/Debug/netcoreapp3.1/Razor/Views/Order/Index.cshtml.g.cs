#pragma checksum "C:\Users\HP\OneDrive\Desktop\Final project000\Final project000\Hello.WebApp\Views\Order\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a4429afb3267e123bb7d28630f274428728a1dc5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a4429afb3267e123bb7d28630f274428728a1dc5", @"/Views/Order/Index.cshtml")]
    ...
    public class Views_Order_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Hello.Application.MTbl_order.Tbl_orderResponse>
    {
        ...
        {
#nullable restore
#line 2 "C:\Users\HP\OneDrive\Desktop\Final project000\Final project000\Hello.WebApp\Views\Order\Index.cshtml"
...
#nullable restore
#line 57 "C:\Users\HP\OneDrive\Desktop\Final project000\Final project000\Hello.WebApp\Views\Order\Index.cshtml"
...
#nullable disable
            WriteLiteral(@"</p>
                                ...
                                <div class=""shadow-ok bg-primary"" style=""width: 25%;border-radius: 8px"">
                                    <p id=""lackMoney"" class=""font-weight-bold text-");
            WriteLiteral("center text-white\" style=\"font-size: 140%;line-height: 39px\">");
#nullable restore
#line 71 "C:\Users\HP\OneDrive\Desktop\Final project000\Final project000\Hello.WebApp\Views\Order\Index.cshtml"
                                                                                                                                           Write(Html.DisplayFor(model => model.total));
...
#nullable disable
            WriteLiteral(@"</p>
                            ...
                            <div id=""totalDisplay"" class=""shadow-ok bg-white"" style=""height: 170px;border-radius: 10px;"">
                                <p class=""text-primary font-weight-bold text-center"" style=""font-size: 350%;line-height: 165px"">");
#nullable restore
#line 75 "C:\Users\HP\OneDrive\Desktop\Final project000\Final project000\Hello.WebApp\Views\Order\Index.cshtml"
                                                                                                                           Write(Html.DisplayFor(model => model.total));
...
#nullable disable
       ...
       ");
            WriteLiteral(@"                                         <p class=""text-center font-weight-bold text-primary pt-2"" style=""font-size: 200%"">2</p>
                                            </div>
                                        </div>
                                        <div class=""float-left p-1"" style=""width: 25%;height: 25%;"">
           ...
           ");
            WriteLiteral(@"                             </div>
                                        ...
                                        <div class=""float-left p-1"" style=""w");
            WriteLiteral(@"idth: 25%;height: 25%;"">
                                        ...
                                        <div class=""float-left p-1"" style=""width: 25%;height: 25%;"">
                                            <div id=""n");
            WriteLiteral(@"umber_9"" class=""bg-white shadow-ok2"" style=""height: 100%;border-radius: 5px"">
                                        ...
                                        <div class=""float-left p-1"" style=""width: 25%;height: 25%;"">
                                            <div id=""number_c"" class=""bg-white shadow-ok2 font-weight-bold text-center pt-2"" style=""height: 100%;border-radius: 5px;fon");
            WriteLiteral(@"t-size: 200%"">
                                                C
                                            </div>
                                        </div>
                                        <div class=""float-left p-1"" style=""width: 25%;height: 25%;"">
            ...
            WriteLiteral(@"                 </div>
                                ...
                                <div class=""pl-3"" style=""width: calc(100% - 350px);"">
                                    <div onclick=""fetchUser()"" data-toggle=""modal"" data-target=""#exampleModal"" class=""bg-white shadow-ok text-center p-2"" style=""width: 100%;border-radius: 8px"">
                                        <p id=""selectUserDisplay"" class=""font-weight-b");
            WriteLiteral(@"old mb-0 text-primary"" style=""font-size: 180%""><i class=""fa fa-user-circle-o mr-3"" aria-hidden=""true""></i>Customer</p>
                                    </div>
                                </div>
    ...
    <script type=""text/javascript"">
        $('#inputSearch').on('keyup', function () {
            ...
            $(document).ready(function () {
                $.ajax({
                 ...
                 ");
            WriteLiteral(@"           var Data = `<div data-dismiss=""modal"" aria-label=""Close"" onclick=""selectCustomer(` + value.id + `,'` + value.name + `')"" class=""infoCustomer--box p-2"">
        ...
        function fetchUser() {
            ...
            $.ajax({
                ...
                dataType: ""json"",
                url: ""htt");
            WriteLiteral(@"ps://localhost:44358/api/Tbl_user"",
                contentType: ""html"",
                success: function (data) {
                    //console.log(data);
                    $.each(data, function (index, value) {
        ...
        var iduser = 0;
     ");
            WriteLiteral(@"   console.log(iduser);
	...
	$(""#number_a"").click(function(){
		if(choosePayment==1){
			...
			number=result
			");
            WriteLiteral(@"console.log(number);
			addMoney();
		}
	});
	...
	function addMoney(){
        ...
        lackMoney = ");
#nullable restore
#line 417 "C:\Users\HP\OneDrive\Desktop\Final project000\Final project000\Hello.WebApp\Views\Order\Index.cshtml"
               Write(Html.DisplayFor(model => model.total));
